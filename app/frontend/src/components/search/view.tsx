...
const tags = [
  {
    label: 'How can I use Native?',
    link: '#',
  },
  {
    label: 'How can I query my documents ?',
    link: '#',
  },
  {
    label: 'How can I upload my own model ?',
    link: '#',
  }
];

export function SearchFrom({ placeholder = "Ask your question on Native's documentation"}: SearchFromProps) {
